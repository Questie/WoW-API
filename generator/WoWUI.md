...
This script performs a multi-step post-processing pass on the generated API folder:
...
2.  **Inject into Target:**
    ...
    - **Smart Injection:**
        ...
        - Filters out `---@meta` and `---@class` tags during mixin injection to avoid conflicts with other definitions.
        - skips injection if patterns match those defined in `inject_mixin_skip.py`.
