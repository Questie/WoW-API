-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SharedTalentUI\Blizzard_TalentButtonSelectExpanded.lua
...
---@class TalentButtonSelectExpandedButtonMixin : Button, TalentButtonSelectMixin
