-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\Shared\CharacterServicesPaidNameChange.lua
...
---@class PNCCharacterSelectBlock : VASCharacterSelectBlockBase
...
---@class PNCAssignConfirmationBlock : VASAssignConfirmationBlockBase
