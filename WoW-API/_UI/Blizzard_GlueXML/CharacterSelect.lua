-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\Classic\CharacterSelect.lua
...
---@class CharacterSelectLockedButtonMixin : Button
CharacterSelectLockedButtonMixin = {};

---@class localizedAtlasMembers
...
---@class UpgradePopupFrameMixin : Frame, BaseExpandableDialogMixin
...
---@class CharacterSelectMailIndicationButtonMixin : Button
...
---@class CharSelectServicesFlowFrameMixin : Frame
