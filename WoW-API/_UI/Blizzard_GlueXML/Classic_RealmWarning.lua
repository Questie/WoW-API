-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\Classic/RealmWarning.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _

---@class RealmWarningPopUpFrameMixin : Frame
RealmWarningPopUpFrameMixin = {};

---@class REALM_WARNING_POPUP_SCREEN
...
---@class RealmWarningPopUpAcceptButtonMixin : Button
...
---@class RealmWarningPopUpDeclineButtonMixin : Button
