-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\Classic/HardcoreFrames.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _
---@class HardcorePopUpFrameMixin : Frame
HardcorePopUpFrameMixin = {};

---@class HARDCORE_POPUP_SCREEN
...
---@class HardcorePopUpAcceptButtonMixin : Button
...
---@class HardcorePopUpDeclineButtonMixin : Button
