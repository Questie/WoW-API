-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\Classic\CharacterServicesPaidNameChange.lua
...
---@class PNCChoiceVerificationBlockClassic : VASChoiceVerificationBlockBase
