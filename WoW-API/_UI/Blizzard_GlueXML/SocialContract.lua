-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GlueXML\SocialContract.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _
---@class SocialContractFrameMixin : Frame
...
---@class SocialContractAcceptButtonMixin : Button
...
---@class SocialContractDeclineButtonMixin : Button
