-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_ActionBar\Shared\MainMenuBarMicroButtons.lua
...
---@class g_visibleMicroButtonAlerts
local g_visibleMicroButtonAlerts = {};
---@class g_flashingMicroButtons
...
---@class SocialsMicroButtonMixin : Button
...
---@class GuildMicroButtonMixin : Button
