-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_CatalogShop\Blizzard_CatalogShop_Elements.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _
-----------------------------------------------------------------------------------
--- NavigationBarButtonMixin
-----------------------------------------------------------------------------------
---@class NavigationBarButtonMixin : Button
NavigationBarButtonMixin = {};
...
-----------------------------------------------------------------------------------
---@class NavigationBarNavigationButtonMixin : Button
NavigationBarNavigationButtonMixin = {};
...
----------------------------------------------------------------------------------
---@class InvisibleMouseOverFrameMixin : Frame
InvisibleMouseOverFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class CatalogShopButtonMixin : Button
CatalogShopButtonMixin = {};
...
----------------------------------------------------------------------------------
---@class CatalogShopPurchaseButtonMixin : Button
CatalogShopPurchaseButtonMixin = {};
...
----------------------------------------------------------------------------------
---@class CatalogShopDetailsButtonMixin : Button
CatalogShopDetailsButtonMixin = {};
...
----------------------------------------------------------------------------------
---@class CatalogShopErrorFrameMixin : Frame
CatalogShopErrorFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class WoWTokenContainerFrameMixin : Frame
WoWTokenContainerFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class ToyContainerFrameMixin : Frame
ToyContainerFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class ServicesContainerFrameMixin : Frame
ServicesContainerFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class CrossGameContainerFrameMixin : Frame
CrossGameContainerFrameMixin = {};
...
----------------------------------------------------------------------------------
---@class CatalogShopDetailsRaceButtonMixin : Button
CatalogShopDetailsRaceButtonMixin = {};
