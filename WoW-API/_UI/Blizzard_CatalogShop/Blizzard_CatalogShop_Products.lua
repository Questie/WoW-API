-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_CatalogShop\Blizzard_CatalogShop_Products.lua
...
---@class CatalogShopProductContainerFrameMixin : Frame
CatalogShopProductContainerFrameMixin = {};
...
-----------------------------------------------------------------------------------
---@class ProductContainerFrameMixin : Frame, CatalogShopProductContainerFrameMixin
