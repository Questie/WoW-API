...
---@class SecureTooltipPreCalls
local SecureTooltipPreCalls = { };
---@class SecureTooltipPostCalls
local SecureTooltipPostCalls = { };
---@class SecureLinePreCalls
local SecureLinePreCalls = { };
---@class SecureLinePostCalls
local SecureLinePostCalls = { };

---@class InsecureTooltipPreCalls
local InsecureTooltipPreCalls = { };
---@class InsecureTooltipPostCalls
local InsecureTooltipPostCalls = { };
---@class InsecureLinePreCalls
local InsecureLinePreCalls = { };
---@class InsecureLinePostCalls
