...
---@class LFG_LIST_CATEGORY_TEXTURES
...
---@class LFG_LIST_PER_EXPANSION_TEXTURES
...
---@class LFGApplicationBrowseGroupsButtonMixin : Button
...
---@class LFG_LIST_ACTIVE_QUEUE_MESSAGE_EVENTS
...
---@class LFGEditBoxMixin : EditBox, LFGAuthenticatorMessagingMixin
...
---@class LFGListLockButtonMixin : Button, LFGAuthenticatorMessagingMixin
...
---@class LFGListCreateGroupDisabledStateButtonMixin : Button, LFGAuthenticatorMessagingMixin
...
---@class LFGListSearchBackToGroupButtonMixin : Button
...
---@class LFGListSearchBackButtonMixin : Button
