-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_WorldMap\Blizzard_WorldMapTemplates.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _
---@class WorldMapFloorNavigationFrameMixin : Frame
...
---@class WorldMapTrackingOptionsButtonMixin : Button
...
---@class WorldMapNavBarButtonMixin : Button
