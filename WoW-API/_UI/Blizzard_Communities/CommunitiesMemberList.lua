-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_Communities\CommunitiesMemberList.lua
...
---@class COMMUNITY_MEMBER_ROLE_NAMES
...
---@class CommunitiesMemberListFactionButtonMixin : Button
