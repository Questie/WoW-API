-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_MoneyFrame\Shared\MoneyFrame.lua
...
---@class MONEY_DENOMINATION_SYMBOLS_BY_DISPLAY_TYPE
...
---@class MoneyDisplayFrameMixin : Frame
