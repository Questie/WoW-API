-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UIPanelTemplates\Classic\UIPanelTemplates.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _

---@class ITEM_SEARCHBAR_LIST
ITEM_SEARCHBAR_LIST = {
	"BagItemSearchBox",
	"GuildItemSearchBox",
	"BankItemSearchBox",
...
---@class UIExpandingButtonMixin : Button
