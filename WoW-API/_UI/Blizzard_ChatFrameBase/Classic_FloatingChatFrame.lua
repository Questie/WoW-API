-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_ChatFrameBase\Classic\FloatingChatFrame.lua
...
---@class FloatingChatFrameButtonFrameMixin : Frame
...
---@class FloatingChatFrameMinimizeButtonMixin : Button
