...
---@class GROUP_LANGUAGE_INDEPENDENT_STRINGS
...
---@class CastSequenceTable
local CastSequenceTable = {};
---@class CastSequenceFreeList
...
---@class ChatEdit_LastTell
local ChatEdit_LastTell = {};
---@class ChatEdit_LastTellType
...
---@class ChatFrameMenuButtonMixin : Button
