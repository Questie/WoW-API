...
---@class BasePagedListContentFrameMixin : Frame, PagedContentFrameBaseMixin
...
---@class PagedVerticalListContentFrameMixin : Frame, BasePagedListContentFrameMixin
...
---@class PagedHorizontalListContentFrameMixin : Frame, BasePagedListContentFrameMixin
