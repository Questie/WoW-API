-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_PagedContent\Blizzard_PagedCondensedGridContentFrame.lua
...
---@class PagedCondensedVerticalGridContentFrameMixin : Frame, PagedContentFrameBaseMixin
