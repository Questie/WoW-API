-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_FrameXMLBase\Classic\Constants.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _

---@class WORLD_QUEST_ICONS_BY_PROFESSION
...
---@class TALENT_SORT_ORDER
TALENT_SORT_ORDER = {
	"spec1",
	"spec2",
};

---@class TALENT_ACTIVATION_SPELLS
...
---@class NEW_ITEM_ATLAS_BY_QUALITY
...
---@class INVSLOTS_EQUIPABLE_IN_COMBAT
...
---@class TOTEM_MULTI_CAST_SUMMON_SPELLS
...
---@class TOTEM_MULTI_CAST_RECALL_SPELLS
...
---@class PET_BATTLE_PET_TYPE_PASSIVES
...
---@class CHALLENGE_MEDAL_TEXTURES
...
---@class CHALLENGE_MEDAL_TEXTURES_SMALL
...
---@class WORLD_QUEST_TYPE_TCOORDS
