...
---@class CURRENT_MAP_QUESTS
CURRENT_MAP_QUESTS = { };
---@class LOCAL_MAP_QUESTS
LOCAL_MAP_QUESTS = { };
---@class VISIBLE_WATCHES
VISIBLE_WATCHES  = { };
...
-- Slide-in Animations
--------------------------------------------------------------------------------------------
---@class WATCHFRAME_SLIDEIN_ANIMATIONS
