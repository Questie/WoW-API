...
---@class GossipSharedTitleButtonMixin : Button
...
---@class GossipSharedQuestButtonMixin : Button, GossipSharedTitleButtonMixin
...
---@class GossipSharedAvailableQuestButtonMixin : Button, GossipSharedQuestButtonMixin
...
---@class GossipSharedActiveQuestButtonMixin : Button, GossipSharedQuestButtonMixin
...
---@class GossipOptionButtonMixin : Button
