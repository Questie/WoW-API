-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UIPanels_Game\Classic\SpellBookFrame.lua
...
---@class SpellBookFrameMixin : Frame
SpellBookFrameMixin = {};
