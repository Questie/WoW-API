-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UIPanels_Game\Classic\UnitPositionFrameTemplates.lua
...
---@class pvpAFKQueryTimers
local pvpAFKQueryTimers = {}


---@class Private_UnitAppearanceData
...
---@class UnitPositionFrameMixin : Frame
