-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UIPanels_Game\Vanilla\QuestInfo.lua
...
---@class QUEST_INFO_SPELL_REWARD_ORDERING
...
---@class QUEST_INFO_SPELL_REWARD_TO_HEADER
