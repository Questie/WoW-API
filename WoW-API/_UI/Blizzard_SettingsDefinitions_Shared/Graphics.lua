-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SettingsDefinitions_Shared\Graphics.lua
...
---@class SettingsAdvancedSliderMixin : Slider, DefaultTooltipMixin
...
---@class SettingsAdvancedCheckboxSliderMixin : Slider, DefaultTooltipMixin
