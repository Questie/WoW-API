-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GroupFinder_VanillaStyle\Blizzard_LFGVanilla_ParentFrame.lua
...
----------LFG Parent
-------------------------------------------------------
---@class LFGParentFrameMixin : Frame
LFGParentFrameMixin = {};
...
---@class ACTIVITY_ACTIVITYGROUP_CACHE
