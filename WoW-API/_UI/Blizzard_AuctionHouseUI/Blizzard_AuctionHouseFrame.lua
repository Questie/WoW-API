-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseFrame.lua
...
---@class AUCTION_HOUSE_STATIC_POPUPS
...
---@class AuctionHouseFrameMixin : Frame, CallbackRegistryMixin
...
---@class AuctionHouseFrameDialogs
AuctionHouseFrameDialogs = {
	"BuyDialog",
};

---@class AuctionHouseFramePopups
