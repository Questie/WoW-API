-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseSharedTemplates.lua
...
---@class AuctionHouseItemDisplayItemButtonMixin : Button
...
---@class AuctionHouseInteractableItemDisplayItemButtonMixin : Button, AuctionHouseItemDisplayItemButtonMixin
...
---@class AuctionHousePriceDisplayFrameMixin : Frame
...
---@class AuctionHouseRefreshFrameMixin : Frame
...
---@class AuctionHouseRefreshButtonMixin : Button
...
---@class AuctionHouseBidFrameMixin : Frame
...
---@class AuctionHouseBuyoutFrameMixin : Frame
...
---@class AuctionHouseBidButtonMixin : Button
...
---@class AuctionHouseBuyoutButtonMixin : Button
