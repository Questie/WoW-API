-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseSellFrame.lua
...
---@class AuctionHouseQuantityInputMaxButtonMixin : Button
...
---@class AuctionHouseAlignedQuantityInputFrameMixin : Frame
...
---@class AuctionHouseAlignedPriceInputFrameMixin : Frame
...
---@class AuctionHousePriceErrorFrameMixin : Frame
...
---@class AuctionHouseSellFramePostButtonMixin : Button
...
---@class AuctionHouseSellFrameMixin : Frame, AuctionHouseSortOrderSystemMixin
