-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseItemBuyFrame.lua
...
---@class AuctionHouseItemBuyFrameMixin : Frame, AuctionHouseBuySystemMixin, AuctionHouseSortOrderSystemMixin
