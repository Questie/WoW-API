-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseAuctionsFrame.lua
...
---@class CancelAuctionButtonMixin : Button
...
---@class AuctionHouseAuctionsFrameMixin : Frame, AuctionHouseBuySystemMixin, AuctionHouseSortOrderSystemMixin
