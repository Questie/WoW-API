-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseBrowseResultsFrame.lua
...
---@class AuctionHouseBrowseResultsFrameMixin : Frame, AuctionHouseSortOrderSystemMixin
