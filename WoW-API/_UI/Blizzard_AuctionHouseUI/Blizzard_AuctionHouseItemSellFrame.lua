-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_AuctionHouseUI\Shared\Blizzard_AuctionHouseItemSellFrame.lua
...
---@class AuctionHouseBuyoutModeCheckButtonMixin : Button
...
---@class AuctionHouseItemSellFrameMixin : Frame, AuctionHouseSellFrameMixin
