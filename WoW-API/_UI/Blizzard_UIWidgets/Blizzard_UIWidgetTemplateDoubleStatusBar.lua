-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UIWidgets\Classic\Blizzard_UIWidgetTemplateDoubleStatusBar.lua
...
---@class UIWidgetTemplateDoubleStatusBarMixin : StatusBar, UIWidgetBaseTemplateMixin
