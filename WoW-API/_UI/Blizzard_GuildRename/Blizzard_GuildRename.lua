-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_GuildRename\Blizzard_GuildRename.lua
...
---@class GuildRenameFrameMixin : Frame
...
---@class GuildRenameContextButtonMixin : Button, SimpleTooltipRegionMixin
