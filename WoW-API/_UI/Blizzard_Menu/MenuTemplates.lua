-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_Menu\MenuTemplates.lua
...
---@class WowFilterButtonMixin : Button, WowDropdownFilterBehaviorMixin
...
---@class WowStyle2IconButtonMixin : Button, ButtonStateBehaviorMixin
