-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SharedWidgetFrames\Blizzard_UIWidgetCenterDisplayFrame.lua
...
---@class WidgetCenterDisplayFrameMixin : Frame
...
---@class UIWidgetCenterDisplayFrameButtonMixin : Button
...
---@class UIWidgetCenterDisplayFrameExtraButtonMixin : Button
