-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_Settings_Shared\Blizzard_CategoryList.lua
...
---@class SettingsCategoryListButtonMixin : Button, ButtonStateBehaviorMixin
