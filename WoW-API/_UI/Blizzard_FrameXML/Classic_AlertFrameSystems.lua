...
---@class LOOTUPGRADEFRAME_QUALITY_TEXTURES
...
---@class GARRISON_FOLLOWER_QUALITY_TEXTURE_SUFFIXES
...
---@class ItemAlertFrameMixin : Frame
ItemAlertFrameMixin = {};
...
---@class NewPetAlertFrameMixin : Frame, ItemAlertFrameMixin
...
---@class NewMountAlertFrameMixin : Frame, ItemAlertFrameMixin
...
---@class NewToyAlertFrameMixin : Frame, ItemAlertFrameMixin
...
---@class ChallengeModeAlertFrameMixin : Frame
