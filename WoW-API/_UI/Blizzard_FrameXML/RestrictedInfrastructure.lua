...
---@class LOCAL_FrameHandle_Protected_Frames
local LOCAL_FrameHandle_Protected_Frames = {};
---@class LOCAL_FrameHandle_Other_Frames
local LOCAL_FrameHandle_Other_Frames = {};
---@class LOCAL_FrameHandle_Lookup
...
---@class LOCAL_Readonly_Restricted_Tables
...
---@class LOCAL_Managed_Environments
