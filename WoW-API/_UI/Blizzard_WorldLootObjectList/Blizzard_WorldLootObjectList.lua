-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_WorldLootObjectList\Blizzard_WorldLootObjectList.lua
...
---@class WorldLootObjectListButtonMixin : Button
...
---@class WorldLootObjectListMixin
