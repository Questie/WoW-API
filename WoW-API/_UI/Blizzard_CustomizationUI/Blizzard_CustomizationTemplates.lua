...
---@class CustomizationContentFrameMixin : Frame
...
---@class CustomizationBaseButtonMixin : Button, CustomizationContentFrameMixin
...
---@class CustomizationSmallButtonMixin : Button, CustomizationFrameWithTooltipMixin, CustomizationContentFrameMixin
...
---@class CustomizationClickOrHoldButtonMixin : Button
