-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_CustomizationUI\Blizzard_CustomizationUI.lua
...
---@class CustomizationRandomizeAppearanceButtonMixin : Button
...
-- Expects to inherit CustomizationSmallButtonMixin
---@class CustomizationResetCameraButtonMixin : Button
...
---@class CustomizationZoomButtonMixin : Button, CustomizationClickOrHoldButtonMixin
...
---@class CustomizationRotateButtonMixin : Button, CustomizationClickOrHoldButtonMixin
...
---@class CustomizationCategoryButtonMixin : Button, CustomizationMaskedButtonMixin, CustomizationContentFrameMixin
