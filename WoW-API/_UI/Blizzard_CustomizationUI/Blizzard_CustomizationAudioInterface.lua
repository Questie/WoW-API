...
---@class CustomizationAudioInterfacePlayButtonMixin : Button, CustomizationFrameWithTooltipMixin
...
---@class CustomizationAudioInterfaceMuteButtonMixin : Button, CustomizationFrameWithTooltipMixin
