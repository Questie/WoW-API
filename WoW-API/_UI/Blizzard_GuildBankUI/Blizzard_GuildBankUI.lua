...
---@class GuildBankFrameMixin : Frame
GuildBankFrameMixin = {};
...
---@class GuildBankTabButtonMixin : Button
...
---@class GuildBankFrameDepositButtonMixin : Button
...
---@class GuildBankFrameWithdrawButtonMixin : Button
...
---@class GuildBankItemButtonMixin : Button
...
---@class GuildBankPopupFrameMixin : Frame
...
---@class GuildBankPopupButtonMixin : Button
...
---@class GuildBankPopupCancelButtonMixin : Button
...
---@class GuildBankPopupOkayButtonMixin : Button
...
---@class GuildBankPopupEditBoxMixin : EditBox
