...
---@class ModifyOrbitCameraButtonMixin : Button
...
---@class WrappedModelSceneMixin : ModelScene
...
---@class WrappedAndUnwrappedModelSceneMixin : ModelScene, WrappedModelSceneMixin
