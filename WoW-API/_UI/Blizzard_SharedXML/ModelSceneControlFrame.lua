...
---@class ModelSceneControlFrameMixin : Frame
...
---@class ModelSceneControlButtonMixin : Button
...
---@class ModelSceneZoomButtonMixin : Button, ModelSceneControlButtonMixin
...
---@class ModelScenelRotateButtonMixin : Button, ModelSceneControlButtonMixin
...
---@class ModelSceneResetButtonMixin : Button, ModelSceneControlButtonMixin
