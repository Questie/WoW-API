-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SharedXML\Classic\SharedUIPanelTemplates.lua
...
---@class PanelTabButtonMixin : Button
PanelTabButtonMixin = {};
...
---@class PanelTopTabButtonMixin : Button
...
---@class MaximizeMinimizeButtonFrameMixin : Frame
...
---@class DefaultScaleFrameMixin : Frame
...
---@class SliderControlFrameMixin : Frame
...
---@class PanelResizeButtonMixin : Button
...
---@class SelectedIconButtonMixin : Button
...
---@class LevelRangeFrameMixin : Frame
...
---@class ResizeCheckButtonMixin : Button
...
---@class AlphaHighlightButtonMixin : Button
...
---@class IconSelectorEditBoxMixin : EditBox
...
---@class UIPanelIconDropdownButtonMixin : Button
