-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SharedXML\ModelSceneMixin.lua
...
---@class PanningModelSceneMixin : ModelScene, ModelSceneMixin
...
---@class NoCameraControlModelSceneMixin : ModelScene, ModelSceneMixin
...
---@class NoZoomModelSceneMixin : ModelScene, ModelSceneMixin
