-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_SharedXML\Shared\FrameTemplate\RingedFrameTemplate.lua
...
---@class RingedMaskedButtonMixin : Button, RingedFrameWithTooltipMixin
