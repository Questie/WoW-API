-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_UnitPopup\UnitPopupCustomControls.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _

---@class UnitPopupAttachableFrameMixin : Frame
...
---@class UnitPopupVoiceToggleButtonMixin : Button
...
---@class UnitPopupVoiceMicrophoneVolumeSliderMixin : Slider
...
---@class UnitPopupVoiceSpeakerVolumeSliderMixin : Slider
...
---@class UnitPopupVoiceUserVolumeSliderMixin : Slider
