-- Original Path: .\WoWUI\Interface\AddOns\Blizzard_VoiceToggleButton\VoiceToggleButton.lua
-- Auto-generated LuaLS Annotations, do not edit manually
---@meta _
---@class VoiceToggleButtonMixin : Button
...
---@class RosterToggleButtonMixin : Button, VoiceToggleButtonMixin
...
---@class RosterSelfDeafenButtonMixin : Button, RosterToggleButtonMixin
...
---@class RosterSelfMuteButtonMixin : Button, RosterToggleButtonMixin
...
---@class RosterMemberMuteButtonMixin : Button, RosterToggleButtonMixin
