...
---@class TabardModel : TabardModelBase
local TabardModel = {}
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_TabardModel_GetLowerBorderFile)
---@return fileID file
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_TabardModel_GetUpperBorderFile)
---@return fileID file
